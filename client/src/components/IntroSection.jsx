  ...
  return (
    <div id="introsection">
      ...
      <h2>
        ...
        question you may have. With Talk-Talk, you'll never be left searching for
        answers again. Whether you need information for school or work, or just
        want to know the latest news, Talk-Talk has you covered.
      </h2>
      Features:
      <ul>
      ...
      <p>
        Say goodbye to endless searching and typing, and say hello to Talk-Talk,
        your personal AI assistant. Try it now and see for yourself how Talk-Talk
